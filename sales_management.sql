...
--
-- Host: localhost:3306
-- Generation Time: Aug 25, 2024 at 04:26 PM
...
CREATE TABLE `accounts` (
  ...
  `initial_debit_balance` double NOT NULL,
  `initial_credit_balance` double NOT NULL
...
CREATE TABLE `products` (
  ...
  `stock` int NOT NULL,
  `link_product_supplier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_id` bigint UNSIGNED NOT NULL,
  `marketplace_id` bigint UNSIGNED NOT NULL,
...
ALTER TABLE `products`
  ...
  ADD KEY `products_marketplace_id_foreign` (`marketplace_id`);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_marketplace_id_foreign` FOREIGN KEY (`marketplace_id`) REFERENCES `marketplaces` (`id`) ON DELETE CASCADE,
